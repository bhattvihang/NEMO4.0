...
CONTAINS
   ...
   SUBROUTINE lbc_lnk_2d_multi( cdname                                                                             &
      ...
      REAL(wp), DIMENSION(:,:), OPTIONAL, TARGET, INTENT(inout) :: pt2  , pt3  , pt4  , pt5  , pt6  , pt7  , pt8  , pt9  , pt10  , pt11
      ...
      TYPE(PTR_2D)         , DIMENSION(11) ::   ptab_ptr    ! pointer array
   ...
   SUBROUTINE lbc_lnk_4d_multi( cdname                                                                             &
      ...
      !!
      INTEGER                          ::   kfld        ! number of elements that will be attributed
      TYPE(PTR_4D)         , DIMENSION(11) ::   ptab_ptr    ! pointer array
      CHARACTER(len=1) , DIMENSION(11) ::   cdna_ptr    ! nature of ptab_ptr grid-points
      REAL(wp)         , DIMENSION(11) ::   psgn_ptr    ! sign used across the north fold boundary
      !!---------------------------------------------------------------------
      !
